...
There are three views for a Canvas dashboard. 
- Code View
- Split View
- Viz View

You can either add charts that you've already made or create components directly within the dashboard. If you want to add a chart you've already created you can select the `+ Add chart` in the UI or start writing YAML to bring in the component into the Canvas dashboard.
...
<TabItem value="Rill_Chart" label="Rill Authored Component " default>
